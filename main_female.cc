...
// Masses.
const long double M1 = 0.04; // g/cm
const long double M2 = 0.008; // g/cm

// Spring constants.
const long double k1 = 53000; // dyne/cm^2
const long double kC = 32000; // dyne/cm^2

// We will step through different values of k2 in the video so that we can find
// the frame with the most accurate value of k2.

const long double k2_start = 20000;  // dyne/cm^2
const long double k2_stop = 40000; // dyne/cm^2
